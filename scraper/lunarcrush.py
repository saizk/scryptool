...
class LunarCrush(object):
    _BASE_URL = 'https://api.lunarcrush.com'

    def __init__(self, api_key):
        self.api_key = api_key

    def _gen_url(self, endpoint, **kwargs):
        url = f'{self._BASE_URL}/v2?data={endpoint}&key={self.api_key}'
    ...
    def get_assets(self, coins, **kwargs):
        """
        :param list coins: List of coins to fetch data for
        ...
        :return:
        """
        kwargs['symbol'] = ','.join(coins)
        return self._get_data('assets', **kwargs)
    ...
    def get_market_pairs(self, coins, **kwargs):
        """
        ...
        """
        kwargs['symbol'] = ','.join(coins)
        return self._get_data('market-pairs', **kwargs)
    ...
    def get_exchange(self, **kwargs):
        ...
        :return:
        """
        return self._get_data('exchange', **kwargs)
    ...
    def get_coin_of_the_day_info(self):
        """
    ...
    def get_feeds(self, coins, **kwargs):
        """
        ...
        """
        kwargs['symbol'] = ','.join(coins)
        return self._get_data('feeds', **kwargs)

    def get_influencer(self, **kwargs):
        """
    ...
    def get_influencers(self, coins, **kwargs):
        """
        ...
        """
        kwargs['symbol'] = ','.join(coins)
        return self._get_data('influencers', **kwargs)
